        ...
        function renderizarProdutos() {
            ...
            const imgMiniatura = produto.imagemUrl 
            ? `<img src="${produto.imagemUrl.replace('/upload/', '/upload/w_48,f_webp,q_auto/')}" style="width:48px;height:48px;object-fit:contain;" loading="lazy">` 
                ...
                ${items.map((produto) => {
                    ...
                    return `
                        <article class="prod-item" draggable="true" data-id="${produto.id}">
                            ...
                            <div class="prod-emoji">${escapeHtml(produto.emoji || "🍽️")}</div>
                            <div class="prod-info">
